...
import com.ionexplus.titu.adapter.ProfileVideosAdapter;
...
public class ProfileVideosViewModel extends ViewModel {
    ...
    public ObservableBoolean noUserVideos = new ObservableBoolean(true);
    public ObservableBoolean noLikedVideos = new ObservableBoolean(true);
