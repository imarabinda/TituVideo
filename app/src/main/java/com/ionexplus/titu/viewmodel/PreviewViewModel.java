...
import com.ionexplus.titu.utils.ProgressRequestBody;
...
public class PreviewViewModel extends ViewModel {
    public String canComment = AppEventsConstants.EVENT_PARAM_VALUE_NO;
    public String canDuet = AppEventsConstants.EVENT_PARAM_VALUE_NO;
    public String canSave = AppEventsConstants.EVENT_PARAM_VALUE_NO;
    ...
    public void uploadPost() {
        ...
        if (soundId != null && !soundId.isEmpty()) {
            ...
            hashMap.put("added_by", toRequestBody( sessionManager.getUser().getData().getUserId()));
            hashMap.put("duration", toRequestBody("1:00"));
            hashMap.put("singer", toRequestBody(sessionManager.getUser().getData().getFullName()));
        }
    ...
    public RequestBody toRequestBodyDesc(String value) {
        return RequestBody.create(MediaType.parse("text/plain"), value);
    }
