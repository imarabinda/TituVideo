...
import com.ionexplus.titu.adapter.ProfileVideoPagerAdapter;
import com.ionexplus.titu.databinding.FragmentProfileBinding;
...
import com.ionexplus.titu.viewmodel.ProfileViewModel;
    ...
    private void initObserver() {
        ...
        viewModel.user.observe(getViewLifecycleOwner(), user -> {
            if (user != null) {
                ...
                if (!TextUtils.isEmpty(user.getData().getProfileCategoryName())) {
    ...
    private void shareProfile() {
        if (getActivity() != null && viewModel.user.getValue() != null) {
            ...
            BranchUniversalObject buo = new BranchUniversalObject()
                    ...
                    .setContentDescription(mFirebaseRemoteConfig.getString("share_profile_text"))
            ...
            buo.generateShortUrl(getActivity(), lp, (url, error) -> {
                ...
                String shareBody = mFirebaseRemoteConfig.getString("share_profile_text").replace("{link}",url).replace("{name}",viewModel.user.getValue().getData().getFullName());
