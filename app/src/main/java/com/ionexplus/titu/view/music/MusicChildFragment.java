...
import com.ionexplus.titu.databinding.FragmentMusicChildBinding;
import com.ionexplus.titu.databinding.ItemMusicBinding;
...
import com.ionexplus.titu.viewmodel.MusicChildViewModel;
    ...
    private void initView() {
        ...
        if (type == 1) {
            if (sessionManager.getFavouriteMusic() != null && !sessionManager.getFavouriteMusic().isEmpty()) {
                ...
                viewModel.noMusicList.set(true);
            }
        } else {
        ...
        if (previousUrl.equals(musics.getSound())) {
            ...
            if (getActivity() != null) {
                ...
                DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(getActivity(),
                        Util.getUserAgent(getActivity(), "TiTu"));
