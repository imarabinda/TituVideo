...
import com.ionexplus.titu.databinding.CustomToastBinding;
import com.ionexplus.titu.databinding.FragmentPurchaseCoinSheetBinding;
import com.ionexplus.titu.utils.CustomDialogBuilder;
import com.ionexplus.titu.viewmodel.CoinPurchaseViewModel;
...
public class CoinPurchaseSheetFragment extends BottomSheetDialogFragment {
    ...
    private void initListeners() {
        viewModel.adapter.setListener((data, position) -> new CustomDialogBuilder(getActivity()).showSimpleDialog("Attention !", "In app purchase not available right now, we're adding it soon.", "OK", "Contact Us", new CustomDialogBuilder.OnDismissListener() {
            @Override
            public void onPositiveDismiss() {
                try {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://wa.me/918334012642")));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
