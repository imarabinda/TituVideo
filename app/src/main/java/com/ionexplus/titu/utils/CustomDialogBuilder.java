...
import com.ionexplus.titu.databinding.DailogLoaderBinding;
import com.ionexplus.titu.databinding.DailogTermConditionBinding;
import com.ionexplus.titu.databinding.LoutPopupBinding;
import com.ionexplus.titu.databinding.LoutSendBubbleBinding;
import com.ionexplus.titu.databinding.LoutSendResultPopupBinding;
        ...
        if (this.mContext != null) {
            ...
            binding.tvTerm.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    mContext.startActivity(new Intent(mContext, WebViewActivity.class).putExtra("type", 0));
                }
            });
            binding.tvPrivacy.setOnClickListener(new View.OnClickListener() {

                public final void onClick(View view) {
                  mContext.startActivity(new Intent(mContext, WebViewActivity.class).putExtra("type", 1));
                }
            });
