...
import com.ionexplus.titu.model.follower.Follower;
import com.ionexplus.titu.model.music.Musics;
import com.ionexplus.titu.model.music.SearchMusic;
import com.ionexplus.titu.model.notification.Notification;
...
import com.ionexplus.titu.model.wallet.CoinPlan;
import com.ionexplus.titu.model.wallet.CoinRate;
import com.ionexplus.titu.model.wallet.MyWallet;
import com.ionexplus.titu.model.wallet.RewardingActions;
...
public interface ApiService {
    ...
    @GET("User/profile_category_list")
    Single<ProfileCategory> getProfileCategoryList(@Header("Authorization") String str);
    ...
    @FormUrlEncoded
    @POST("Post/banners")
    Single<Banner> getBanners(@Field("my_user_id") String myUserId);
    ...
    @Multipart
    @POST("Post/add_post")
    Single<User> uploadSoundIdPost(@Header("Authorization") String token,
                            @PartMap HashMap<String, RequestBody> hasMap,
                            @Part MultipartBody.Part postVideo,
                            @Part MultipartBody.Part postImage);
    ...
    @FormUrlEncoded
    @POST("Wallet/check_in_reward")
    Single<RestResponse> dailyReward(@Header("Authorization") String token,@Field("rewarding_action_id") String rewardActionId);
